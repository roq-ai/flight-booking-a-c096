...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Airports', path: '/airports', entity: 'airport', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    { name: 'Bookings', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Flights', path: '/flights', entity: 'flight', service: AccessServiceEnum.PROJECT, icon: FiNavigation },
    { name: 'Tickets', path: '/tickets', entity: 'ticket', service: AccessServiceEnum.PROJECT, icon: FiCreditCard },
